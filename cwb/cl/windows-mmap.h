...
#ifdef _WIN64   /* file should not be included in the first place if not on Windows - but this is just to be sure. */

#include <winsock2.h>   /* must be included before windows.h if it's ever going to be included */
#include <windows.h>
#include <sys/stat.h>
#include <stdint.h>
#include <stdio.h>
