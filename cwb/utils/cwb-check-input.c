 ...
 *
 *
 * This was a temporary, experimental "fiddle" with unicode programming.
 *
 * The best way to REALLY "check input" would be to run cwb-encode in a no-output-write mode.
 *
 */
...
cwbci_encoding_ok(char *str)
{
  ...
  default:
    /* dunno what to do here, esp. about latin[2-9] */
    break;
  }
