...
/* it is a bit confusing that there is both a -P option for attributes, AND you can list attributes
 * after the corpus name. (Or is there a difference between these two ways of specifying attributes?)
 * especially since the normally parallel huffcode **does not** have attributes after the corpus!
 * oh well, this is a wart that will be left behind in v 4.
 */
